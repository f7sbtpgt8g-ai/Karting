...
def guardian_consent_email(to_email: str, driver_name: str, consent_link: str) -> Email:
    return Email(
        ...
        body=(
            ...
            f"{consent_link}\n\n"
            "The account stores lap timing data from their kart's logger. Sessions are private by default "
            "and are only ever shared if they explicitly choose to share them.\n\n"
            "If you don't recognise this, you can ignore this email and the account will stay inactive."
        ),
    )
...
def claim_invite_email(to_email: str, driver_name: str, uploaded_by: str, sessions_summary: str, claim_link: str) -> Email:
    ...
    return Email(
        ...
        body=(
            ...
            f"{sessions_summary}\n\n"
            "This data is private. Nobody else can see it, and it won't appear on any leaderboard.\n\n"
